  ...
  mounted: function () {
    ...
    scene.onPointerPick = (evt, pickInfo) => {
      if (pickInfo.hit) {
        ...
        const r = Math.floor(pickInfo.pickedMesh.material.baseColor.r * 256)
        const g = Math.floor(pickInfo.pickedMesh.material.baseColor.g * 256)
        const b = Math.floor(pickInfo.pickedMesh.material.baseColor.b * 256)
