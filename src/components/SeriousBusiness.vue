...
div.section-padding
  div.container
    ...
    div.card-columns.mt-4
      div.card
        img.card-img-top(card.img.top src="@/assets/card-playraven.jpg" alt="Logo")
        div.card-body
      ...
      div.card
        ...
        div.card-body
          ...
          h6.card-subtitle.text-muted.mb-2 Mobile Game
          p.card-text Mobile SKU of the most successful bubble shooter at the time. Game of the week in App Store etc. etc.
      ...
      div.card
        ...
        div.card-body
          ...
          h6.card-subtitle.text-muted.mb-2 Mobile Game
          p.card-text Mobile SKU of Wooga's biggest arcade game at the time. We were the first game to ship with Facebook Connect and other bleeding edge social features.
      ...
      div.card
        ...
        div.card-body
          ...
          h6.card-subtitle.text-muted.mb-2 Company
          p.card-text IGDA Finland's tech backbone that handles all events and memberships across thousands of people ever year. Open sourced under MIT.
      ...
      div.card
        ...
        div.card-body
          ...
          h6.card-subtitle.text-muted.mb-2 Company
          p.card-text I founded Finland's first game development club in Tampere Polytechnic University.
