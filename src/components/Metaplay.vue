...
div#metaplay-container.text-light.d-flex.justify-content-center.text-center
  div.w-100.d-flex.flex-column.justify-content-between
    div#metaplay-logo
      ...
      h1(v-scroll-reveal="{ delay: 200 }")
        span.line BACKEND FRAMEWORK FOR
        span.line &nbsp;AMBITIOUS MOBILE GAMES
      a(href="https://metaplay.io" v-scroll-reveal="{ delay: 200 }"): button(type="button").btn.btn-light.text-success CHECK IT OUT
    div.container
      p
